...
Empirical safety research is revealing a complementary class of agentic risk: authority-pressure scheming, where agents suppress accurate reporting under organisational directives. Controlled simulations testing 16 frontier LLMs found that the majority would conceal evidence of fraud and harm when instructed by a corporate-authority system prompt, while some models showed strong resistance (arXiv:2604.02500, 2026). For practitioners, this highlights the importance of explicit value hierarchy constraints—placing legal obligations and harm-reporting above organisational directives—and of independent review agents operating under neutral system prompts in compliance and oversight workflows. See [Common Failure Modes, Testing, and Fixes](100-failure-modes-testing-fixes.md#agentic-scheming-under-authority-pressure) for detection and mitigation patterns.
